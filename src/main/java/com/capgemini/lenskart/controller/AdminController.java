...
//            return new ResponseEntity<ProductDTO>(adminService.updateProduct(productDTO), HttpStatus.ACCEPTED);
//        }
//
...
//            ProductDTO productDTO =adminService.getById(id);
//            return adminService.deleteProduct(productDTO);
//        }
//     @GetMapping("/products")
//        public ResponseEntity<List<ProductDTO>> getAllProduct(){
//            List<ProductDTO> list=adminService.findAll();
